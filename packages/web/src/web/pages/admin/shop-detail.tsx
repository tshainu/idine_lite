...
interface User { id: number; username: string; plainPassword: string | null; role: string; isActive: boolean; createdAt: string; }
...
export default function ShopDetail() {
  ...
  const [visiblePwIds, setVisiblePwIds] = useState<Set<number>>(new Set());
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-1.5 mt-0.5">
                        <span className="text-[11px] text-gray-400">PW:</span>
                        {u.plainPassword ? (
                          <>
                            <span className="text-[11px] font-mono text-gray-700 select-all">
                              {visiblePwIds.has(u.id) ? u.plainPassword : "••••••••"}
                            </span>
                            <button
                              type="button"
                              ...
                              title={visiblePwIds.has(u.id) ? "Hide" : "Show"}
                            >
                              {visiblePwIds.has(u.id) ? (
